...
5. 나머지 R9 장치(폼 5종 + issue-lint, 게이트, 직렬화, 훅)는 변경 없음.
...
- 사람 1회 설정 잔여: 리포 Settings → Code security → **Private vulnerability reporting 활성화**(이 토글 없이는 advisories/new 경로가 외부인에게 닫혀 있음).
